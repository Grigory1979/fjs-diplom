...
- [Дипломный проект на курсе Fullstack-разработчик на JavaScript»](#дипломный-проект-на-курсе-fullstack-разработчик-на-javascript)
  - [Cайт-агрегатор просмотра и бронирования гостиниц](#cайт-агрегатор-просмотра-и-бронирования-гостиниц)
  ...
  - [2.1. API Модуля «Гостиницы»](#21-api-модуля-гостиницы)
    ...
    - [**2.1.2. Информация о конкретном номере**](#212-информация-о-конкретном-номере)
      - [**Описание**](#описание)
      - [**Адрес**](#адрес-1)
      - [**Query-параметры**](#query-параметры-1)
      - [**Формат ответа**](#формат-ответа-1)
      - [**Доступ**](#доступ-1)
    - [**2.1.3. Добавление гостиницы**](#213-добавление-гостиницы)
      - [**Описание**](#описание-1)
      - [**Адрес**](#адрес-2)
      - [**Body-параметры**](#body-параметры)
      - [**Формат ответа**](#формат-ответа-2)
      - [**Доступ**](#доступ-2)
      - [**Ошибки**](#ошибки)
    - [**2.1.4. Получение списка гостиниц**](#214-получение-списка-гостиниц)
      - [**Описание**](#описание-2)
      - [**Адрес**](#адрес-3)
      - [**Query-параметры**](#query-параметры-2)
      - [**Формат ответа**](#формат-ответа-3)
      - [**Доступ**](#доступ-3)
      - [**Ошибки**](#ошибки-1)
    - [**2.1.5. Изменение описания гостиницы**](#215-изменение-описания-гостиницы)
      - [**Описание**](#описание-3)
      - [Страница гостиницы:](#страница-гостиницы)
      - [**Адрес**](#адрес-4)
      - [**Body-параметры**](#body-параметры-1)
      - [**Формат ответа**](#формат-ответа-4)
      - [**Доступ**](#доступ-4)
      - [**Ошибки**](#ошибки-2)
    - [**2.1.6. Добавление номера**](#216-добавление-номера)
      - [**Описание**](#описание-4)
      - [**Адрес**](#адрес-5)
      - [**Body-параметры**](#body-параметры-2)
      - [**Формат ответа**](#формат-ответа-5)
      - [**Доступ**](#доступ-5)
      - [**Ошибки**](#ошибки-3)
    - [**2.1.7. Изменение описания номера**](#217-изменение-описания-номера)
      - [**Описание**](#описание-5)
      - [**Адрес**](#адрес-6)
      - [**Body-параметры**](#body-параметры-3)
      - [**Формат ответа**](#формат-ответа-6)
      - [**Доступ**](#доступ-6)
      - [**Ошибки**](#ошибки-4)
  ...
  - [2.3. API Модуля «Аутентификация и авторизация»](#23-api-модуля-аутентификация-и-авторизация)
    - [**2.3.1. Вход**](#231-вход)
      ...
      - [**Адрес**](#адрес-12)
      - [**Body-параметры**](#body-параметры-5)
      - [**Формат ответа**](#формат-ответа-12)
      - [**Доступ**](#доступ-12)
      - [**Ошибки**](#ошибки-10)
    - [**2.3.2. Выход**](#232-выход)
      - [**Описание**](#описание-12)
      - [**Адрес**](#адрес-13)
      - [**Формат ответа**](#формат-ответа-13)
      - [**Доступ**](#доступ-13)
    - [**2.3.3. Регистрация**](#233-регистрация)
      - [**Описание**](#описание-13)
      - [**Адрес**](#адрес-14)
      - [**Body-параметры**](#body-параметры-6)
      - [**Формат ответа**](#формат-ответа-14)
      - [**Доступ**](#доступ-14)
      - [**Ошибки**](#ошибки-11)
  - [2.4. API Модуля «Управление пользователями»](#24-api-модуля-управление-пользователями)
    - [**2.4.1. Создание пользователя**](#241-создание-пользователя)
      ...
      - [**Адрес**](#адрес-15)
      - [**Body-параметры**](#body-параметры-7)
      - [**Формат ответа**](#формат-ответа-15)
      - [**Доступ**](#доступ-15)
      - [**Ошибки**](#ошибки-12)
    - [**2.4.2. Получение списка пользователей**](#242-получение-списка-пользователей)
      - [**Описание**](#описание-15)
      - [**Адрес**](#адрес-16)
      - [**Query-параметры**](#query-параметры-3)
      - [**Формат ответа**](#формат-ответа-16)
      - [**Доступ**](#доступ-16)
      - [**Ошибки**](#ошибки-13)
  - [2.5. API модуля «Чат с техподдержкой»](#25-api-модуля-чат-с-техподдержкой)
    - [**2.5.1. Создание обращения в поддержку**](#251-создание-обращения-в-поддержку)
      ...
      - [**Адрес**](#адрес-17)
      - [**Body-параметры**](#body-параметры-8)
      - [**Формат ответа**](#формат-ответа-17)
      - [**Доступ**](#доступ-17)
      - [**Ошибки**](#ошибки-14)
    - [**2.5.2. Получение списка обращений в поддержку для клиента**](#252-получение-списка-обращений-в-поддержку-для-клиента)
      ...
      - [**Адрес**](#адрес-18)
      - [**Query-параметры**](#query-параметры-4)
      - [**Формат ответа**](#формат-ответа-18)
      - [**Доступ**](#доступ-18)
      - [**Ошибки**](#ошибки-15)
    - [**2.5.3. Получение списка обращений в поддержку для менеджера**](#253-получение-списка-обращений-в-поддержку-для-менеджера)
      ...
      - [**Адрес**](#адрес-19)
      - [**Query-параметры**](#query-параметры-5)
      - [**Формат ответа**](#формат-ответа-19)
      - [**Доступ**](#доступ-19)
      - [**Ошибки**](#ошибки-16)
